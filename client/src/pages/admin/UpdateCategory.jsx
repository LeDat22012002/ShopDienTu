...
import { apiGetAllBrands, apiUpdateCategories } from '../../apis';
...
const UpdateCategory = ({ editCategory, render, setEditCategory }) => {
    ...
    const handleUpdateCategory = async (data) => {
        ...
        const response = await apiUpdateCategories(formData, editCategory?._id);
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-x-4 gap-y-2">
                            {brands?.map((brand) => (
                                <InputCheckbox
                                    ...
                                    errors={errors}
                                    defaultChecked={editCategory?.brand?.some(
                                        (b) => b._id === brand._id
                                    )}
                                />
                            ))}
