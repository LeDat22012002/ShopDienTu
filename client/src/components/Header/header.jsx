            ...
            <div className="flex text-[13px]">
                ...
                <div className="relative group">
                    ...
                    >
                        ...
                        <span className="absolute z-50 flex items-center justify-center w-6 h-5 text-xs font-bold text-white bg-red-500 border border-gray-100 rounded-full shadow-md -top-1 right-2">
                            {cartItems?.length || 0}
                        </span>
                    </div>
